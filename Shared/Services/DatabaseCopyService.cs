...
public interface IDatabaseCopyService
{
    Task SyncAllChangesToRemoteAsync();
    Task CopyDatabaseToLocalAsync();
    Task CopyDatabaseToRemoteAsync();
    Task SyncRecordToRemoteAsync(int recordId, bool isActive, DateTime modificationDate);
}
